...
plt.plot([0,1,2,3],toplot,color=colors[3],marker="o",label="BX")
print(min(toplot))
print(max(toplot))
...
for curr in range(4):
    ...
    toplot.append(toexport["LR_waystream"][curr] / toexport["LR"][curr])
plt.plot([0,1,2,3],toplot,color=colors[1],marker="o",label="LR")
print(min(toplot))
print(max(toplot))
