...
max_consumption=np.max([(np.mean(x)*10*8760)/1000 for x in results])
print(max_consumption)
plt.bar([0],max_consumption,width=0.8,color=colors[3],label="Regular SFP")
...
max_consumption=np.max([(np.mean(x)*10*8760)/1000 for x in results])
print(max_consumption)
plt.bar([1],max_consumption,width=0.8,color=colors[1],label="Waystream SFP")
...
max_consumption=np.max([(np.mean(x)*10*8760)/1000 for x in results])
print(max_consumption)
plt.bar([2],max_consumption,width=0.8,color=colors[3])
...
max_consumption=np.max([(np.mean(x)*10*8760)/1000 for x in results])
print(max_consumption)
plt.bar([3],max_consumption,width=0.8,color=colors[1])


plt.xticks([0.5,2.5],["LR","BX"])
