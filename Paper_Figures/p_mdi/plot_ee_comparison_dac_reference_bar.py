...
plt.bar([0, 5, 10, 15], [np.mean(x)*100 for x in toplot], color=colors[2], label="Waystream LR")
...
for curr in range(len(toplot)):
    ...
    min_values.append((math.sqrt(
        (math.sqrt(np.std(all_res_sfp[curr]) ** 2 + max_uncertainty) / np.mean(all_res_sfp[curr])) ** 2 + (
                math.sqrt(np.std(all_res_dac[curr]) ** 2 + max_uncertainty) / np.mean(
            all_res_dac[curr])) ** 2)) * np.mean(toplot[curr]) * 100)
plt.errorbar([0,5,10,15],[np.mean(x)*100 for x in toplot],yerr=[min_values,max_values],fmt='none',ecolor="black",elinewidth=10)
...
for curr in range(4):
    ...
    all_res_sfp.append(raw_values_sfp)
    all_res_dac.append(raw_values_dac)
plt.bar([1, 6, 11, 16], [np.mean(x)*100 for x in toplot], color=colors[4], label="FS.com LR")
...
for curr in range(len(toplot)):
    ...
    min_values.append((math.sqrt(
        (math.sqrt(np.std(all_res_sfp[curr]) ** 2 + max_uncertainty) / np.mean(all_res_sfp[curr])) ** 2 + (
                math.sqrt(np.std(all_res_dac[curr]) ** 2 + max_uncertainty) / np.mean(
            all_res_dac[curr])) ** 2)) * np.mean(toplot[curr]) * 100)
plt.errorbar([1, 6, 11, 16],[np.mean(x)*100 for x in toplot],yerr=[min_values,max_values],fmt='none',ecolor="black",elinewidth=10)
...
for curr in range(4):
    ...
    all_res_sfp.append(raw_values_sfp)
    all_res_dac.append(raw_values_dac)
plt.bar([2, 7, 12, 17], [np.mean(x)*100 for x in toplot], color=colors[6], label="FS.com BX")
...
for curr in range(len(toplot)):
    ...
    min_values.append((math.sqrt(
        (math.sqrt(np.std(all_res_sfp[curr]) ** 2 + max_uncertainty) / np.mean(all_res_sfp[curr])) ** 2 + (
                math.sqrt(np.std(all_res_dac[curr]) ** 2 + max_uncertainty) / np.mean(
            all_res_dac[curr])) ** 2)) * np.mean(toplot[curr]) * 100)
plt.errorbar([2, 7, 12, 17],[np.mean(x)*100 for x in toplot],yerr=[min_values,max_values],fmt='none',ecolor="black",elinewidth=10)
...
for curr in range(4):
    ...
    all_res_sfp.append(raw_values_sfp)
    all_res_dac.append(raw_values_dac)
plt.bar([3, 8, 13, 18], [np.mean(x)*100 for x in toplot], color=colors[8], label="Waystream BX")
...
for curr in range(len(toplot)):
    ...
    min_values.append((math.sqrt(
        (math.sqrt(np.std(all_res_sfp[curr]) ** 2 + max_uncertainty) / np.mean(all_res_sfp[curr])) ** 2 + (
                math.sqrt(np.std(all_res_dac[curr]) ** 2 + max_uncertainty) / np.mean(
            all_res_dac[curr])) ** 2)) * np.mean(toplot[curr]) * 100)
plt.errorbar([3, 8, 13, 18],[np.mean(x)*100 for x in toplot],yerr=[min_values,max_values],fmt='none',ecolor="black",elinewidth=10)


plt.xticks([1.5, 6.5, 11.5, 16.5], [0,125,500,1000])
...
#plt.show()
plt.savefig('ee_comparison_Switch.png')
plt.close()
