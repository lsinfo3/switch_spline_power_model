...
for curr in range(4):
    ...
    toplot.append(toexport["BX_waystream"][curr] / toexport["BX"][curr])
plt.plot([0,1,2,3],toplot,color=colors[3],marker="o",label="Waystream BX as Reference")
print(min(toplot))
print(max(toplot))
...
for curr in range(4):
    ...
    toplot.append(toexport["BX"][curr] / toexport["BX_waystream"][curr])
plt.plot([0,1,2,3],toplot,color=colors[1],marker="o",label="Regular BX as Reference")
print(min(toplot))
print(max(toplot))
